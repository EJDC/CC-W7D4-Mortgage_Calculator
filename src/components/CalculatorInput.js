...
const CalculatorInput = ({
  onMainIncomeUpdated,
  onSecondIncomeUpdated,
  onDepositUpdated,
  onMonthlyCommitmentsUpdated,
  onInterestRateUpdated,
  onLengthOfMortgageUpdated,
}) => {
  ...
  return (
    <>
      <form>
        <ul>
          <li>
            <label htmlFor="main-applicant-salary">
              Your Annual Salary (£)
            </label>
            <input
          ...
          <li>
            ...
            <input id="deposit" type="number" onChange={handleDepositChange} />
          </li>
          <li>
